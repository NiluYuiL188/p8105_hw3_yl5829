...
print(ny_noaa_clean)
```
By observing the result 0 is the most commonly for snowfall. It means most of the time it does not snow at NY.
...
ny_noaa_new %>%
  ggplot(aes(x = year, y = mean_tmax, group = id)) + geom_line() +
  facet_grid(~month) +
  labs(title = "Mean monthly temperature for each station across years for January and July")
```
Temperature is much lower for 1 compare to 7, and the variability of temperature in 1 is higher than in 7. In 7 there is one outlier stand out around 1986,7.
